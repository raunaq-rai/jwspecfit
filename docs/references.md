...
|------|----------|-------------|-------|
| High ionisation | O$^{2+}$, Ne$^{2+}$ | $T_e$(high) = $T_e$([OIII]) | [OIII] 4363, 4959, 5007; [NeIII] 3869 |
| Low ionisation | O$^+$, N$^+$, S$^+$ | $T_e$(low) = $T_e$([OII]) | [OII] 3726, 3729; [NII] 6585; [SII] 6718, 6732 |

Intermediate ions (S$^{2+}$, Ar$^{2+}$) use
$T_\mathrm{mid} = (T_\mathrm{high} + T_\mathrm{low}) / 2$.

The contribution of O$^{3+}$/H$^+$ to the total oxygen abundance
...
PyNEB solves for $T_e$ numerically using atomic data for the O$^{2+}$
...
When [NII] 5756 is detected, $T_e$(N$^+$) is measured directly from
...
|-----|---------|------|-----------|
| O$^{2+}$/H$^+$ | [OIII] 5007 | High | `Atom("O", 3)` |
| O$^+$/H$^+$ | [OII] 3726+3729 | Low | `Atom("O", 2)` |
| N$^+$/H$^+$ | [NII] 6585 | Low | `Atom("N", 2)` |
| S$^+$/H$^+$ | [SII] 6718+6732 | Low | `Atom("S", 2)` |
| S$^{2+}$/H$^+$ | [SIII] 9069 | Mid | `Atom("S", 3)` |
| Ne$^{2+}$/H$^+$ | [NeIII] 3869 | High | `Atom("Ne", 3)` |
| Ar$^{2+}$/H$^+$ | [ArIII] 7136 | Mid | `Atom("Ar", 3)` |
...
- **Collision strengths:**
  ...
  - O$^{2+}$: Aggarwal & Keenan (1999) / Storey, Sochi & Badnell (2014)
  - N$^+$: Tayal (2011)
...
No ICF is applied for higher ionisation states; the O$^{3+}$
...
O$^+$ and N$^+$ (e.g. Nava et al. 2006; Amayo et al. 2021).
...
ICF from Izotov et al. (2006, eq. 20), accounting for S$^{3+}$.
...
|-----------|--------|-------|-------|------|
| Electron temperature | $\log_{10} T_e$ | [3.5, 5.0] | Uniform | K |
| Electron density | $\log_{10} n_e$ | [0.0, 5.0] | Uniform | cm$^{-3}$ |
| Per-ion abundance | $\log_{10}(X^{i+}/\mathrm{H}^+)$ | [$-7$, $-2$] (oxygen); [$-8$, $-3$] (N, Ne); [$-9$, $-4$] (S, Ar) | Uniform in log (= log-uniform in linear) | — |
...
2. **Single $T_e$ zone in the forward model.** The forward model
   ...
   both O$^+$ and O$^{2+}$ are free parameters.
...
- Aggarwal, K. M. & Keenan, F. P. 1999, ApJS, 123, 311 — O$^{2+}$ collision strengths
...
- Storey, P. J., Sochi, T. & Badnell, N. R. 2014, MNRAS, 441, 3028 — O$^{2+}$ collision strengths
